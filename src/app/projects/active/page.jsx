...
import { 
  Folder, Plus, Search, Calendar, Clock, Users, Target, CheckCircle, 
  AlertTriangle, PauseCircle, PlayCircle, MoreVertical, Star, Bookmark, 
  Share2, Settings, TrendingUp, TrendingDown, BarChart3, PieChart, Activity,
  User, Mail, Phone, MapPin, Globe, Github, Slack, Figma, Edit3, Trash2, 
  Copy, Download, Upload, RefreshCw, Bell, ChevronRight, ChevronDown, 
  ExternalLink, Award, Zap, Calendar as CalendarIcon, Grid, List, Kanban, 
  Timeline, Sun, Moon, Palette, Eye, EyeOff, Lock, Unlock, Archive, 
  MessageSquare, FileText, Image, Video, Code, Database, Lightbulb, Brain, 
  Rocket, Flag, Shield, Heart, Coffee, X, DollarSign
} from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';

// Reusing the projectsData structure, filtered for active projects
const projectsData = {
  projects: [
    {
      id: 1,
    ...
    },
    {
      ...
      tasks: { total: 62, completed: 28, inProgress: 12, pending: 22 },
      milestones: [
    ...
    },
    {
      ...
      tasks: { total: 41, completed: 32, inProgress: 6, pending: 3 },
      milestones: [
  ...
  categories: [
    { id: 'all', name: 'All Projects', count: 3, color: 'gray' },
...
const ActiveProjectsPage = () => {
  ...
  const handleCreateProject = async (e) => {
    ...
    projectsData.stats.activeProjects += 1;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <h1 className={`text-2xl font-bold ${currentTheme.text}`}>Active Projects</h1>
              <div className="flex items-center space-x-2">
                <motion.div
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h2 className={`text-xl font-semibold ${currentTheme.text}`}>Create New Active Project</h2>
                <motion.button
                  onClick={() => setShowCreateModal(false)}
                  className={`p-1 rounded-lg ${currentTheme.hover} ${currentTheme.text}`}
                  whileHover={{ scale: 1.1 }}
